...
//                         Join Video Kit
//                     </h1>
//                     <p className="text-[#212842]/60 font-medium text-sm tracking-wide">Create your premium creator profile</p>
//                 </div>
...
//                         type="submit"
//                         disabled={loading}
//                         className="w-full py-4 mt-6 bg-[#212842] text-[#F0E7D5] font-bold text-lg rounded-xl shadow-lg shadow-[#212842]/30 hover:shadow-xl hover:-translate-y-0.5 transition-all active:scale-95 disabled:opacity-50"
//                     >
//                         {loading ? "Creating Account..." : "Create Account"}
//                     </button>
//                 </form>

//                 <p className="mt-8 text-center text-[#212842]/60 font-medium text-sm">
//                     Already registered?{" "}
//                     <Link
//                         href="/login"
            ...
            <div className="relative w-full max-w-[1050px] bg-[#3B415A]/85 backdrop-blur-xl rounded-[20px] shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)] flex flex-col md:flex-row z-10 border border-white/10 min-h-[580px]">
                    ...
                    <div className="w-full max-w-[380px]">
                        ...
                        <div className="text-center" style={{ marginBottom: '32px' }}>
                            ...
                            <p className="text-gray-300 text-[14px]">
                                Create your premium creator profile
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="text-center">
                                <p className="text-[#A3A8B8] text-[13px]">
                                    Already registered? <Link href="/login" className="text-[#FCD771] hover:underline">Sign in</Link>
                                </p>
                            </div>
                        </form>
                    </div>
                ...
                <div className="hidden md:flex w-[50%] relative items-center justify-center p-8">
                    ...
                    <div className="relative w-[340px] h-[340px] bg-[#FCD771] rounded-full flex items-center justify-center overflow-hidden border-4 border-transparent">
                        {/* Next.js strict Image component */}
